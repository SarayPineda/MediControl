...
public class IngresosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_ingresos, container, false);
        ...
        cantidadText = vista.findViewById(R.id.cantidadIngreso);
        fechaText = vista.findViewById(R.id.fechaIngreso);
    ...
    private void capturarFecha(){
        ...
        text = vista.findViewById(R.id.fechaIngreso);
    ...
    private void limpiarCampos(){
        ...
        fechaText.setText("Fecha de ingreso");
    }
